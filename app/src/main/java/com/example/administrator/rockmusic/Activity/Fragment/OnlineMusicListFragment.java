...
import com.example.administrator.rockmusic.Bean.MusicDownLoadBean;
...
import com.example.administrator.rockmusic.Bean.SongListInfo;
import com.example.administrator.rockmusic.R;
import com.example.administrator.rockmusic.adapter.OnlineMusicListAdapter;
import com.example.administrator.rockmusic.utils.Constants;
import com.example.administrator.rockmusic.utils.JsonCallBack.JsonCallBack;
import com.example.administrator.rockmusic.utils.JsonCallBack.JsonOnlineMusicList;
...
public class OnlineMusicListFragment extends BaseFragment implements View.OnClickListener
    ...
    public void initView() {
        ...
        /*指定了布局的宽和高  .MATCH_PARENT该布局的尺寸将填满它的父控件*/
